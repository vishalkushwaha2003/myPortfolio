  ...
  return (
    <div className="w-full h-full  flex justify-center items-center">
      <div className="lg:w-[50%] lg:h-[80%] sm:w-[70%] sm:h-[80%] w-[96%] h-[96%] bg-[rgba(251,185,182,0.05)] rounded-xl flex flex-col">
        <div className="w-[100%] h-[10%] flex justify-center items-center sm:text-3xl text-2xl font-bold">
        ...
        <div className="h-[90%] w-full p-2 flex flex-col space-y-4 overflow-scroll">
          ...
          <div className="text-wrap flex flex-col space-y-4">
          <div className="sm:text-3xl text-2xl">User Registration and Authentication</div>
          <div className="sm:text-xl text-lg">
...
For users who have already signed up, the application offers a straightforward login process. By entering their username and password, users can quickly access their accounts and continue their conversations without the need to sign up again.
          ...
          <div className="text-wrap flex flex-col space-y-4">
          <div className="sm:text-3xl text-2xl">Real-Time Messaging with Socket.IO</div>
          <div className="sm:text-xl text-lg">
          ...
          <div className="text-wrap flex flex-col space-y-4">
          <div className="sm:text-3xl text-2xl">Backend and Database Management</div>
          <div className="sm:text-xl text-lg">
          ...
          <div className="text-wrap flex flex-col space-y-4">
          <div className="sm:text-3xl text-2xl">Deployment on Render</div>
          <div className="sm:text-xl text-lg">
          ...
          <div className="text-wrap flex flex-col space-y-4">
          <div className="sm:text-3xl text-2xl">Online Status Indicator</div>
          <div className="sm:text-xl text-lg">
          ...
          <div className="text-wrap flex flex-col space-y-4">
          <div className="sm:text-3xl text-2xl">Signup and Login Process</div>
          <div className="sm:text-xl text-lg">
         ...
         <br></br> <b>Login :</b> For returning users, the login process is simple. Users input their username and password, which are validated against the stored credentials in the database. Upon successful authentication, users can access their accounts and resume chatting.
          ...
          <div className="text-wrap flex flex-col space-y-4">
          <div className="sm:text-3xl text-2xl">User Interface Design</div>
          <div className="sm:text-xl text-lg">
