...
function About() {
  return (
    <div className=' p-10 flex flex-col space-y-5 '>
      ...
      <div className='text-[30px] font-bold text-[rgba(255,255,255,0.8)] animate__animated animate__bounceInDown'>About me</div>
        <div className='text-[20px] text-[rgba(255,255,255,0.6)] animate__animated animate__bounceInRight'> 
