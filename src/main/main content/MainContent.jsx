  ...
  return (
    ...
    >
      <div className=" h-[30vh] w-full sm:h-[30vh] sm:w-full md:h-[35vh] md:w-full lg:h-full lg:w-[25%] flex gap-0 sm:flex-row md:flex-row lg:flex-col sm:gap-3">
        ...
        <div className="hidden sm:flex sm:border-[0.5px] rounded-3xl sm:border-[rgb(251,185,182)] hover:shadow-[0px_0px_12px_2px_rgba(241,176,176,0.4)] duration-300 sm:w-[60%] sm:h-full md:w-[60%] md:h-full lg:h-[50%] lg:w-full sm:text-white sm:justify-center sm:items-center">
    will update soon .....
</div>
